...
@section('title')
    @lang('messages.add') @lang('messages.periods')
@endsection
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> @lang('messages.add') @lang('messages.periods') </h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-md-8">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">@lang('messages.add') @lang('messages.periods') </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{route('periods.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="start_at" type="time" class="form-control" value="{{old('start_at')}}" placeholder="@lang('messages.start_at')">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="end_at" type="time" class="form-control" value="{{old('end_at')}}" placeholder="@lang('messages.end_at')">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="people_count" type="number" class="form-control" value="{{old('people_count')}}" placeholder="@lang('messages.period_people_count')">
