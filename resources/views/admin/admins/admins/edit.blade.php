                    ...
                    <div class="card card-primary">
                        ...
                        <form class="form-horizontal" method="post" action="{{ url('/admin/admins/'. $data->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="attendance_code" class="col-lg-3 control-label">@lang('messages.attendance_code')</label>
                                    <div class="col-lg-9">
                                        <input id="attendance_code" name="attendance_code" type="text" value="{{ $data->attendance_code }}" class="form-control" placeholder="@lang('messages.attendance_code')">
                                        @if ($errors->has('attendance_code'))
                                            <span class="help-block">
                                       <strong style="color: red;">{{ $errors->first('attendance_code') }}</strong>
                                    </span>
                                        @endif
                                    </div>
                                </div>
